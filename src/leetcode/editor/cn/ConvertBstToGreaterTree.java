...
//leetcode submit region begin(Prohibit modification and deletion)
    ...
    class Solution {
        ...
        private int sumTreeRec(TreeNode root, int initSum) {
            if (root == null) {
                return 0;
            }

            int rightSum = sumTreeRec(root.right, initSum);
            int curVal = root.val;
            int leftSum = sumTreeRec(root.left, initSum + curVal + rightSum);

            root.val = curVal + rightSum + initSum;
