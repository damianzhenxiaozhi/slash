...
public class IntersectionOfTwoLinkedLists {
    public static void main(String[] args) {
        ...
        MyList listA = new MyList(new int[]{4, 1});
        MyList listB = new MyList(new int[]{5, 0});
        MyList listC = new MyList(new int[]{8, 4, 5});
        listA.addListAtTail(listC);
        listB.addListAtTail(listC);
        ListNode node = s.getIntersectionNode(listA.getHead(), listB.getHead());
        MyList.print(node);
    }
